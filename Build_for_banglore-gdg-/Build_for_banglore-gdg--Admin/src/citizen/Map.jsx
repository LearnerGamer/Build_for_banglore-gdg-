...
const Map = ({ onMarkerClick, zoom = 13, center, userLoc, rescueMode = false, highlightId }) => {
  const mapCenter = center || userLoc || USER_LOC;
  return (
    <div style={{ width: '100%', height: '100%', position: 'relative' }}>
      ...
      >
        ...
        {/* User Location */}
        <Marker position={userLoc || USER_LOC} icon={UserIcon} />
